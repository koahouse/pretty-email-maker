  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text>
          <p>
            \${strings.WE_HOPE_YOUR_SESSION_WITH} \${therapistFirstName} \${strings.WENT_WELL}.
          </p>
        </mj-text>
        <mj-text>
          <p>
            \${strings.YOUR_NEXT_SESSION_IS_SCHEDULED_FOR} <strong>\${prettyDate}</strong>.
          </p>
        </mj-text>
...
const getHtmlEmail = () =>{
  ...
  const htmlFileName = `sessionConfirmation.html`;
