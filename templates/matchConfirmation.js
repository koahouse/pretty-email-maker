  ...
  <mj-body>
    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text>
          <p>
            \${strings.THANKS_AGAIN_FOR_ATTENDING}.
          </p>
        </mj-text>
        <mj-text>
          <p>
						\${strings.AFTER_CAREFULLY_REVIEWING}.
          </p>
        </mj-text>
        <mj-text>
          <p>
            \${strings.YOURE_ALL_SET_FOR_YOUR_FIRST} \${therapistFullName} \${strings.ON} <strong>\${date}</strong>.
          </p>
        </mj-text>
        ...
        <mj-text>
          <p>
						\${strings.WHEN_ITS_TIME} \${videoCallLink} \${strings.TO_JOIN_THE_CALL}.
          </p>
        </mj-text>
        <mj-text>
          <p>
            \${strings.I_HAVE_ATTACHED} \${therapistFirstName}. \${strings.ITS_ENCRYPTED}.
          </p>
        </mj-text>
        <mj-text>
          <p>
        ...
        <mj-text>
          <p>
            \${strings.FROM_HERE_ON_ALL_YOU_NEED} \${therapistFirstName} \${strings.TO_SEE_HOW_THINGS_ARE_GOING}.
          </p>
        </mj-text>
        <mj-text>
          <p>
...
const getHtmlEmail = () =>{
  ...
  const htmlFileName = `matchConfirmation.html`;
